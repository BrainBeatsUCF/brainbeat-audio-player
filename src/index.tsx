...
const useStyles = makeStyles(() => ({
  ...
  const callback = (currentAudioPlaying: any, indexPlaying: number):void => {
   try{
    currentAudioPlaying(indexPlaying);
   }
   catch(e){
      console.error(e);
   }
    ...
    return (
      <div>
        ...
        <AudioPlayer
          ...
          onPlay={e => {callback(props.currentAudioPlaying, indexPlaying)}}
          onEnded={playForward}
